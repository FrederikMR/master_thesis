...
def parse_args():
    ...
    parser.add_argument('--data_path', default="../../Data/CelebA/celeba", 
                        type=str)
    parser.add_argument('--save_path', default='rm_computations/mnist_geodesic.pt', 
                        type=str)
    ...
    parser.add_argument('--load_model_path', default='trained_models/mnist/mnist_epoch_50000.pt',
                        type=str)
...
def main():
    ...
    img0 = rot[idx].reshape(1,-1)
    
    thetaT = 0.0
    idx = np.argmin(np.abs(theta-thetaT))
    imgT = rot[idx].reshape(1,-1)
