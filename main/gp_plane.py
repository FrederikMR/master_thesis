...
def fun(x1, x2):
    ...
    return jnp.array([x1, x2, jnp.zeros_like(x1)])
...
RM = rm.rm_geometry(param_fun=lambda x: jnp.array([x[0], x[1], 0.0]), method='euler')
...
load_path = 'rm_computations/plane_simple_geodesic.pt'
