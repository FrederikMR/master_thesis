...
class VAE_CELEBA(nn.Module):
    def __init__(self,
        ...
        #Encoder
        self.h_con1 = nn.Conv2d(in_channels = 3, out_channels = 16, kernel_size = 2, stride = 2, bias = False) #31x31z32
        self.h_batch1 = nn.BatchNorm2d(16)
        
        self.h_con2 = nn.Conv2d(in_channels = 16, out_channels = 16, kernel_size = 2, stride = 2, bias = False) #14x14x32
        self.h_batch2 = nn.BatchNorm2d(16)
        
        self.h_con3 = nn.Conv2d(in_channels = 16, out_channels = 32, kernel_size = 2, stride = 2, bias = False) #6x6x64
        self.h_batch3 = nn.BatchNorm2d(32)
        
        self.h_con4 = nn.Conv2d(in_channels = 32, out_channels = 32, kernel_size = 2, stride = 2, bias = False) #2x2x64
        self.h_batch4 = nn.BatchNorm2d(32)
        
        self.h_fc = nn.Linear(128, 128)
        self.h_batch5 = nn.BatchNorm1d(128)
        ...
        self.g_tcon1 = nn.ConvTranspose2d(in_channels = 128, out_channels = 32, kernel_size = 2, stride = 2)
        self.g_batch2 = nn.BatchNorm2d(32)
        
        self.g_tcon2 = nn.ConvTranspose2d(in_channels = 32, out_channels = 32, kernel_size = 2, stride = 2)
        self.g_batch3 = nn.BatchNorm2d(32)
        
        self.g_tcon3 = nn.ConvTranspose2d(in_channels = 32, out_channels = 16, kernel_size = 2, stride = 2)
        self.g_batch4 = nn.BatchNorm2d(16)
        
        self.g_tcon4 = nn.ConvTranspose2d(in_channels = 16, out_channels = 16, kernel_size = 2, stride = 2)
        self.g_batch5 = nn.BatchNorm2d(16)
        
        self.g_tcon5 = nn.ConvTranspose2d(in_channels = 16, out_channels = 3, kernel_size = 2, stride = 2)
